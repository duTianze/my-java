...
import com.dutianze.designpattern.behavioral.interceptingfilter.filter.impl.*;
...
class FilterTest {
    ...
    static List<Object[]> getTestData() {
        return List.of(
                ...
                new Object[]{new FilterChain().add(new ContactFilter()), WRONG_CONTACT, "Invalid contact number!"},
                ...
                new Object[]{new FilterChain().add(new DepositFilter()), WRONG_DEPOSIT, "Invalid deposit number!"},
