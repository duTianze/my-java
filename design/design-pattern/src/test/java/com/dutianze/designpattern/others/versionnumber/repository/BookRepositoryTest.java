package com.dutianze.designpattern.others.versionnumber.repository;

import com.dutianze.designpattern.others.versionnumber.entity.Book;
import com.dutianze.designpattern.others.versionnumber.exception.BookDuplicateException;
import com.dutianze.designpattern.others.versionnumber.exception.BookNotFoundException;
import com.dutianze.designpattern.others.versionnumber.exception.VersionMismatchException;
import com.dutianze.designpattern.others.versionnumber.repository.impl.BookRepositoryImpl;
...
class BookRepositoryTest {
    ...
    @Test
    void aliceAndBobHaveDifferentVersionsAfterAliceUpdate() throws BookNotFoundException, VersionMismatchException {
    ...
    @Test
    void throwVersionMismatchExceptionOnStaleUpdate() throws BookNotFoundException, VersionMismatchException {
        final Book aliceBook = bookRepository.get(bookId);
        final Book bobBook = bookRepository.get(bookId);
