...
class DomainEventProcessorTest {
  ...
  void testStateRecovery() {
    ...
    assertEquals(accountOfDaenerysBeforeShotDown.getAvailable(),
        accountOfDaenerysAfterShotDown.getAvailable());
    assertEquals(accountOfJonBeforeShotDown.getAvailable(),
        accountOfJonAfterShotDown.getAvailable());
  }
}