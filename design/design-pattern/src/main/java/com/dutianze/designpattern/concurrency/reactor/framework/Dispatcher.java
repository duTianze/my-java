 ...
 * I/O processing from application specific processing. <br> Dispatcher should call the
 * {@link ChannelHandler} associated with the channel on which event occurred.
 *
