...
import com.dutianze.util.PrettyPrinter;
...
public class N_1476_SubrectangleQueries {
    ...
    private final Deque<Operation> ops;
    ...
    public void updateSubrectangleHistory(int row1, int col1, int row2, int col2, int newValue) {
        ops.push(new Operation(row1, row2, col1, col2, newValue));
    }

    public int getValueHistory(int row, int col) {
    ...
    private static class Operation {
        ...
        public Operation(int r1, int r2, int c1, int c2, int v) {
            row1 = r1;
            row2 = r2;
            col1 = c1;
            col2 = c2;
